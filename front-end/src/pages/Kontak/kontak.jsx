    ...
    return (
        <div className="min-h-screen w-full bg-[#f3ecdc] flex flex-col items-center relative overflow-x-hidden pt-10 md:pt-20 pb-10">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none">
                <img src={bgPattern} alt="Background Pattern" className="w-full h-full object-cover opacity-20 md:opacity-40" />
            </div>
            ...
            <div className="relative z-10 w-full max-w-6xl px-4 md:px-6 flex flex-col items-center">
                ...
                <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-y-10 md:gap-y-0 mb-20 border-t border-[#2f4156]/10 pt-12">
                    ...
                    <div className="flex gap-4 px-4">
                        ...
                        <div className="flex flex-col">
                            <h3 className="font-black text-[#1f2937] uppercase text-xs tracking-widest mb-1">Alamat Kantor Desa</h3>
                            <p className="text-[#2f4156] font-serif italic text-sm leading-relaxed">Jl. Niskala Wastukancana, Sidodadi Asri, Lampung</p>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-4 px-4 md:border-l border-[#2f4156]/20">
                        ...
                        <div className="flex flex-col">
                            <h3 className="font-black text-[#1f2937] uppercase text-xs tracking-widest mb-1">Email Resmi</h3>
                            <p className="text-[#2f4156] font-serif italic text-sm">sidodadiasri@gmail.com</p>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-4 px-4 md:border-l border-[#2f4156]/20">
                        ...
                        <div className="flex flex-col">
                            <h3 className="font-black text-[#1f2937] uppercase text-xs tracking-widest mb-2">Jenis Layanan</h3>
                            <ul className="text-[#2f4156] font-serif italic text-sm space-y-2">
                                <li className="flex items-center gap-2"><img src={checkIcon1} className="w-3" alt="v" /> Administrasi Umum</li>
                                <li className="flex items-center gap-2"><img src={checkIcon2} className="w-3" alt="v" /> Surat Keterangan</li>
                                <li className="flex items-center gap-2"><img src={checkIcon3} className="w-3" alt="v" /> Layanan Aspirasi</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-4 px-4 md:border-l border-[#2f4156]/20">
                        ...
                        <div className="flex flex-col">
                            <h3 className="font-black text-[#1f2937] uppercase text-xs tracking-widest mb-1">Jam Pelayanan</h3>
                            <p className="text-[#2f4156] font-serif italic text-sm leading-tight">
                                Senin - Jumat<br />
                                <span className="font-sans font-bold not-italic">08.00 - 15.00 WIB</span>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-center gap-6 mt-4 w-full">
                    ...
                    <h4 className="font-black text-[#1f2937] text-xs uppercase tracking-[0.3em]">Media Sosial Kami</h4>
                    <div className="flex flex-wrap justify-center gap-8 md:gap-10">
                        <a href="https://instagram.com/sidodadiasri" target="_blank" rel="noopener noreferrer" className="hover:scale-125 transition-transform duration-300">
                            <img src={instaIcon} className="w-9 h-9 md:w-10 md:h-10" alt="Instagram" />
                        </a>
                        <a href="#" className="hover:scale-125 transition-transform duration-300">
                            <img src={fbIcon} className="w-9 h-9 md:w-10 md:h-10" alt="Facebook" />
                        </a>
                        <a href="#" className="hover:scale-125 transition-transform duration-300">
                            <img src={webIcon} className="w-9 h-9 md:w-10 md:h-10" alt="Website" />
                        </a>
                        <a href="#" className="hover:scale-125 transition-transform duration-300">
                            <img src={tiktokIcon} className="w-9 h-9 md:w-10 md:h-10" alt="TikTok" />
                        </a>
                    </div>
                    <p className="text-[10px] text-[#1f2937]/40 uppercase tracking-widest mt-8 font-bold">© 2026 Desa Sidodadi Asri</p>
                </div>
            </div>
        </div>
    );
