...
const API = "https://desasidodadiasri.my.id/api/layanan";
const API_KERAMAIAN = "https://desasidodadiasri.my.id/api/layanan/keramaian";
...
const LayananForm = () => {
  ...
  const submit = async (e) => {
    ...
    if (ttl.includes(",")) {
      ...
      fd.append(
        "tgl_lahir",
        parseIndonesianDate(parts.slice(1).join(",").trim()),
      );
    } else {
    ...
    if (jenisLayanan === "keramaian") {
      ...
      try {
        ...
        alert(
          "Pengajuan berhasil dikirim. Anda dapat cek status di halaman Cek Status.",
        );
        resetAllForms();
      } catch (err) {
        console.error(err);
        alert(
          "Tidak dapat terhubung ke server. Pastikan backend berjalan di https://desasidodadiasri.my.id/api",
        );
      } finally {
        setLoading(false);
      }
  ...
  const inputClass =
    "w-full px-3 py-2 text-sm rounded-lg border border-gray-300 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500";
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-6">
          ...
          <p className="text-gray-600 text-sm">
            Silakan isi data berikut. Berkas persyaratan dibawa langsung ke
            Balai Desa.
          </p>
        </div>
        ...
        <form onSubmit={submit} className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            <h2 className="text-base font-semibold text-teal-700 mb-4">
              Data Umum Pemohon
            </h2>
          ...
          <div className="bg-gray-100 rounded-xl shadow p-8">
            ...
            <div>
              ...
              >
                ...
                <option value="pengantar-kk">
                  Surat Pengantar Kartu Keluarga
                </option>
                <option value="keterangan-pindah">
          ...
          {jenisLayanan === "keramaian" && (
            <div className="bg-white rounded-xl shadow-lg p-8 space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className={labelClassGray}>
                      Pemilik acara (Nama lengkap)
                    </label>
                    <input
                      name="pemilik_acara_nama"
                      placeholder="Masukkan nama lengkap pemilik acara"
                      value={formKeramaian.pemilik_acara_nama}
                      onChange={handleKeramaianChange}
                      className={inputClass}
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <input
                      name="jenis_hiburan"
                      placeholder="Masukkan jenis hiburan"
                      value={formKeramaian.jenis_hiburan}
                      onChange={handleKeramaianChange}
                      className={inputClass}
                    />
                  </div>
                  <div>
                    ...
                    <input
                      name="nama_hiburan"
                      placeholder="Masukkan nama hiburan"
                      value={formKeramaian.nama_hiburan}
                      onChange={handleKeramaianChange}
                      className={inputClass}
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      value={formKeramaian.nama_pimpinan}
                      onChange={handleKeramaianChange}
                      className={inputClass}
                    />
                  </div>
                  <div>
                    ...
                    <input
                      name="undang_berapa_orang"
                      placeholder="Masukkan jumlah undangan"
                      value={formKeramaian.undang_berapa_orang}
                      onChange={handleKeramaianChange}
                      className={inputClass}
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      value={formKeramaian.bertempat_di}
                      onChange={handleKeramaianChange}
                      className={inputClass}
                    />
                  </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className={labelClassGray}>
                      Pemilik hiburan (Nama lengkap)
                    </label>
                    <input
                      name="pemilik_hiburan_nama"
                      placeholder="Masukkan nama lengkap pemilik hiburan"
                      value={formKeramaian.pemilik_hiburan_nama}
                      onChange={handleKeramaianChange}
                      className={inputClass}
                    />
                  </div>
                  <div>
                    ...
                    <input
                      name="acara_hiburan"
                      placeholder="Masukkan jenis acara"
                      value={formKeramaian.acara_hiburan}
                      onChange={handleKeramaianChange}
                      className={inputClass}
                    />
                  </div>
                  <div>
                    <label className={labelClassGray}>Jenis hiburan</label>
                    <input
                      name="jenis_hiburan_hiburan"
                      placeholder="Masukkan jenis hiburan"
                      value={formKeramaian.jenis_hiburan_hiburan}
                      onChange={handleKeramaianChange}
                      className={inputClass}
                    />
                  </div>
                  <div>
                    <label className={labelClassGray}>Nama hiburan</label>
                    <input
                      name="nama_hiburan_hiburan"
                      placeholder="Masukkan nama hiburan"
                      value={formKeramaian.nama_hiburan_hiburan}
                      onChange={handleKeramaianChange}
                      className={inputClass}
                    />
                  </div>
                  <div>
                    <label className={labelClassGray}>Nama pimpinan</label>
                    <input
                      name="nama_pimpinan_hiburan"
                      placeholder="Masukkan nama pimpinan"
                      value={formKeramaian.nama_pimpinan_hiburan}
                      onChange={handleKeramaianChange}
                      className={inputClass}
                    />
                  </div>
                  <div>
                    ...
                    <input
                      name="undang_berapa_orang_hiburan"
                      placeholder="Masukkan jumlah undangan"
                      value={formKeramaian.undang_berapa_orang_hiburan}
                      onChange={handleKeramaianChange}
                      className={inputClass}
                    />
                  </div>
                  <div className="md:col-span-2">
                    <label className={labelClassGray}>Bertempat di</label>
                    <input
                      name="bertempat_di_hiburan"
                      placeholder="Masukkan lokasi acara"
                      value={formKeramaian.bertempat_di_hiburan}
                      onChange={handleKeramaianChange}
                      className={inputClass}
                    />
                  </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleAnggotaKeluargaChange(index, e)
                          }
                          className={inputClass}
                          required
                        />
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        name="nama_kepala_keluarga"
                        placeholder="Masukkan nama lengkap"
                        value={formPindah.nama_kepala_keluarga}
                        onChange={handlePindahChange}
                        className={inputClass}
                        required
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        placeholder="16 digit NIK"
                        value={formPindah.nik_kepala_keluarga}
                        onChange={handlePindahChange}
                        className={inputClass}
                        required
                      />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className={labelClassGray}>
                        Nomor HP Pemohon (Jika ada)
                      </label>
                      <input
                        name="nomor_hp"
                        placeholder="Contoh: 081234567890"
                        value={formPindah.nomor_hp}
                        onChange={handlePindahChange}
                        className={inputClass}
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div>
                      <label className={labelClassGray}>
                        Kode Pos Asal (Jika ada)
                      </label>
                      <input
                        name="kode_pos_asal"
                        placeholder="12345"
                        value={formPindah.kode_pos_asal}
                        onChange={handlePindahChange}
                        className={inputClass}
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        value={formPindah.kecamatan_asal}
                        onChange={handlePindahChange}
                        className={inputClass}
                        required
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={formPindah.kabupaten_asal}
                        onChange={handlePindahChange}
                        className={inputClass}
                        required
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={formPindah.provinsi_asal}
                        onChange={handlePindahChange}
                        className={inputClass}
                        required
                      />
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      value={formPindah.alamat_tujuan}
                      onChange={handlePindahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div>
                      <label className={labelClassGray}>
                        Kode Pos Tujuan (Jika ada)
                      </label>
                      <input
                        name="kode_pos_tujuan"
                        placeholder="12345"
                        value={formPindah.kode_pos_tujuan}
                        onChange={handlePindahChange}
                        className={inputClass}
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="Nama kecamatan"
                        value={formPindah.kecamatan_tujuan}
                        onChange={handlePindahChange}
                        className={inputClass}
                        required
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="Nama kabupaten/kota"
                        value={formPindah.kabupaten_tujuan}
                        onChange={handlePindahChange}
                        className={inputClass}
                        required
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="Nama provinsi"
                        value={formPindah.provinsi_tujuan}
                        onChange={handlePindahChange}
                        className={inputClass}
                        required
                      />
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input
                      name="alasan_pindah"
                      placeholder="Contoh: Pekerjaan, Pendidikan"
                      value={formPindah.alasan_pindah}
                      onChange={handlePindahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Contoh: Dalam satu desa/antar desa"
                      value={formPindah.klasifikasi_kepindahan}
                      onChange={handlePindahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    <label className={labelClassGray}>
                      Tanggal Rencana Pindah
                    </label>
                    <input
                      name="tanggal_rencana_pindah"
                      placeholder="DD/MM/YYYY"
                      value={formPindah.tanggal_rencana_pindah}
                      onChange={handlePindahChange}
                      className={inputClass}
                      required
                    />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          value={anggota.nama_lengkap}
                          onChange={(e) => handleAnggotaPindahChange(index, e)}
                          className={inputClass}
                          required
                        />
                      </div>
          ...
          {jenisLayanan === "ahli-waris" && (
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                <div>
                  <label className={labelClass}>
                    Nama lengkap yang memberi warisan
                  </label>
                  <input
                ...
                <div>
                  <label className={labelClass}>
                    Nama pasangan yang memberi warisan{" "}
                    <span className="text-gray-500">(Jika ada)</span>
                  </label>
                  <input
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <ul className="space-y-1 text-teal-700 text-sm">
                      ...
                      <li>
                        Akte kematian (bukan surat keterangan kematian) dari
          ...
          {jenisLayanan === "nikah" && (
            <div className="bg-white rounded-xl shadow-lg p-8 space-y-8">
              ...
              {/* Data Orang Tua Pemohon */}
              <div>
                <h3 className="text-base font-semibold text-teal-700 mb-4">
                  Data Orang Tua Pemohon
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      value={formNikah.ortu_ayah_nama}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      name="ortu_ayah_kk"
                      placeholder="Masukkan nomor KK ayah"
                      value={formNikah.ortu_ayah_kk}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    ...
                    <input
                      name="ortu_ibu_kk"
                      placeholder="Masukkan nomor KK ibu"
                      value={formNikah.ortu_ibu_kk}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    ...
                    <input
                      name="ortu_ayah_ttl"
                      placeholder="Contoh: Surabaya, 5 Mei 1965"
                      value={formNikah.ortu_ayah_ttl}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    ...
                    <input
                      name="ortu_ibu_ttl"
                      placeholder="Contoh: Bandung, 12 Juni 1970"
                      value={formNikah.ortu_ibu_ttl}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    ...
                    <input
                      name="ortu_ayah_agama"
                      placeholder="Masukkan agama ayah"
                      value={formNikah.ortu_ayah_agama}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={formNikah.ortu_ibu_agama}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    ...
                    <input
                      name="ortu_ayah_kewarganegaraan"
                      placeholder="Masukkan kewarganegaraan ayah"
                      value={formNikah.ortu_ayah_kewarganegaraan}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    ...
                    <input
                      name="ortu_ibu_kewarganegaraan"
                      placeholder="Masukkan kewarganegaraan ibu"
                      value={formNikah.ortu_ibu_kewarganegaraan}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    ...
                    <input
                      name="ortu_ayah_status_perkawinan"
                      placeholder="Masukkan status perkawinan ayah"
                      value={formNikah.ortu_ayah_status_perkawinan}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    ...
                    <input
                      name="ortu_ibu_status_perkawinan"
                      placeholder="Masukkan status perkawinan ibu"
                      value={formNikah.ortu_ibu_status_perkawinan}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    ...
                    <input
                      name="ortu_ayah_pekerjaan"
                      placeholder="Masukkan pekerjaan ayah"
                      value={formNikah.ortu_ayah_pekerjaan}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    ...
                    <input
                      name="ortu_ibu_pekerjaan"
                      placeholder="Masukkan pekerjaan ibu"
                      value={formNikah.ortu_ibu_pekerjaan}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    ...
                    <textarea
                      name="ortu_ayah_alamat"
                      placeholder="Masukkan alamat lengkap ayah"
                      value={formNikah.ortu_ayah_alamat}
                      onChange={handleNikahChange}
                      className={inputClass + " min-h-[80px]"}
                      required
                    />
                  ...
                  <div>
                    ...
                    <textarea
                      name="ortu_ibu_alamat"
                      placeholder="Masukkan alamat lengkap ibu"
                      value={formNikah.ortu_ibu_alamat}
                      onChange={handleNikahChange}
                      className={inputClass + " min-h-[80px]"}
                      required
                    />
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      name="calon_nama"
                      placeholder="Masukkan nama lengkap calon pasangan"
                      value={formNikah.calon_nama}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    ...
                    <input
                      name="calon_nik"
                      placeholder="Masukkan NIK calon pasangan"
                      value={formNikah.calon_nik}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    <label className={labelClass}>Kewarganegaraan</label>
                    <input
                      name="calon_kewarganegaraan"
                      placeholder="Masukkan kewarganegaraan"
                      value={formNikah.calon_kewarganegaraan}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    ...
                    <input
                      name="calon_kk"
                      placeholder="Masukkan nomor KK calon pasangan"
                      value={formNikah.calon_kk}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    <label className={labelClass}>Status Perkawinan</label>
                    <input
                      name="calon_status_perkawinan"
                      placeholder="Lajang/Janda/Duda"
                      value={formNikah.calon_status_perkawinan}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    <label className={labelClass}>Jenis Kelamin</label>
                    <input
                      name="calon_jenis_kelamin"
                      placeholder="Laki-laki / Perempuan"
                      value={formNikah.calon_jenis_kelamin}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    <label className={labelClass}>Pekerjaan</label>
                    <input
                      name="calon_pekerjaan"
                      placeholder="Masukkan pekerjaan"
                      value={formNikah.calon_pekerjaan}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    ...
                    <input
                      name="calon_ttl"
                      placeholder="Contoh: Yogyakarta, 8 Februari 1995"
                      value={formNikah.calon_ttl}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className={labelClass}>Nama Lengkap Ayah</label>
                    <input
                      name="ortu_calon_ayah_nama"
                      placeholder="Masukkan nama lengkap ayah"
                      value={formNikah.ortu_calon_ayah_nama}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    <label className={labelClass}>Nama Lengkap Ibu</label>
                    <input
                      name="ortu_calon_ibu_nama"
                      placeholder="Masukkan nama lengkap ibu"
                      value={formNikah.ortu_calon_ibu_nama}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    <label className={labelClass}>NIK Ayah</label>
                    <input
                      name="ortu_calon_ayah_nik"
                      placeholder="Masukkan NIK ayah"
                      value={formNikah.ortu_calon_ayah_nik}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    <label className={labelClass}>NIK Ibu</label>
                    <input
                      name="ortu_calon_ibu_nik"
                      placeholder="Masukkan NIK ibu"
                      value={formNikah.ortu_calon_ibu_nik}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    <label className={labelClass}>Nomor KK Ayah</label>
                    <input
                      name="ortu_calon_ayah_kk"
                      placeholder="Masukkan nomor KK ayah"
                      value={formNikah.ortu_calon_ayah_kk}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    <label className={labelClass}>Nomor KK Ibu</label>
                    <input
                      name="ortu_calon_ibu_kk"
                      placeholder="Masukkan nomor KK ibu"
                      value={formNikah.ortu_calon_ibu_kk}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    ...
                    <input
                      name="ortu_calon_ayah_ttl"
                      placeholder="Contoh: Semarang, 15 Juli 1960"
                      value={formNikah.ortu_calon_ayah_ttl}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    ...
                    <input
                      name="ortu_calon_ibu_ttl"
                      placeholder="Contoh: Bandung, 12 Juni 1970"
                      value={formNikah.ortu_calon_ibu_ttl}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    <label className={labelClass}>Agama Ayah</label>
                    <input
                      name="ortu_calon_ayah_agama"
                      placeholder="Masukkan agama ayah"
                      value={formNikah.ortu_calon_ayah_agama}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    <label className={labelClass}>Agama Ibu</label>
                    <input
                      name="ortu_calon_ibu_agama"
                      placeholder="Masukkan agama ibu"
                      value={formNikah.ortu_calon_ibu_agama}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    <label className={labelClass}>Kewarganegaraan Ayah</label>
                    <input
                      name="ortu_calon_ayah_kewarganegaraan"
                      placeholder="Masukkan kewarganegaraan ayah"
                      value={formNikah.ortu_calon_ayah_kewarganegaraan}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    <label className={labelClass}>Kewarganegaraan Ibu</label>
                    <input
                      name="ortu_calon_ibu_kewarganegaraan"
                      placeholder="Masukkan kewarganegaraan ibu"
                      value={formNikah.ortu_calon_ibu_kewarganegaraan}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    <label className={labelClass}>Status Perkawinan Ayah</label>
                    <input
                      name="ortu_calon_ayah_status_perkawinan"
                      placeholder="Masukkan status perkawinan ayah"
                      value={formNikah.ortu_calon_ayah_status_perkawinan}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    <label className={labelClass}>Status Perkawinan Ibu</label>
                    <input
                      name="ortu_calon_ibu_status_perkawinan"
                      placeholder="Masukkan status perkawinan ibu"
                      value={formNikah.ortu_calon_ibu_status_perkawinan}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    <label className={labelClass}>Pekerjaan Ayah</label>
                    <input
                      name="ortu_calon_ayah_pekerjaan"
                      placeholder="Masukkan pekerjaan ayah"
                      value={formNikah.ortu_calon_ayah_pekerjaan}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    <label className={labelClass}>Pekerjaan Ibu</label>
                    <input
                      name="ortu_calon_ibu_pekerjaan"
                      placeholder="Masukkan pekerjaan ibu"
                      value={formNikah.ortu_calon_ibu_pekerjaan}
                      onChange={handleNikahChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    <label className={labelClass}>Alamat Ayah</label>
                    <textarea
                      name="ortu_calon_ayah_alamat"
                      placeholder="Masukkan alamat lengkap ayah"
                      value={formNikah.ortu_calon_ayah_alamat}
                      onChange={handleNikahChange}
                      className={inputClass + " min-h-[80px]"}
                      required
                    />
                  ...
                  <div>
                    <label className={labelClass}>Alamat Ibu</label>
                    <textarea
                      name="ortu_calon_ibu_alamat"
                      placeholder="Masukkan alamat lengkap ibu"
                      value={formNikah.ortu_calon_ibu_alamat}
                      onChange={handleNikahChange}
                      className={inputClass + " min-h-[80px]"}
                      required
                    />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      value={formPenghasilan.nama_lengkap_wali}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={formPenghasilan.nik_wali}
                      onChange={handlePenghasilanChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    <label className={labelClass}>
                      Tempat, tanggal lahir wali (Jika ada)
                    </label>
                    <input
                      name="tempat_tanggal_lahir_wali"
                      placeholder="Contoh: Jakarta, 15 Agustus 1975"
                      value={formPenghasilan.tempat_tanggal_lahir_wali}
                      onChange={handlePenghasilanChange}
                      className={inputClass}
                    />
                  </div>
                  <div>
                    <label className={labelClass}>
                      Jenis kelamin wali (Jika ada)
                    </label>
                    <input
                      name="jenis_kelamin_wali"
                      placeholder="Laki-laki / Perempuan"
                      value={formPenghasilan.jenis_kelamin_wali}
                      onChange={handlePenghasilanChange}
                      className={inputClass}
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      value={formPenghasilan.agama_wali}
                      onChange={handlePenghasilanChange}
                      className={inputClass}
                    />
                  </div>
                  <div>
                    <label className={labelClass}>
                      Pekerjaan wali (Jika ada)
                    </label>
                    <input
                      name="pekerjaan_wali"
                      placeholder="Masukkan pekerjaan wali"
                      value={formPenghasilan.pekerjaan_wali}
                      onChange={handlePenghasilanChange}
                      className={inputClass}
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      value={formPenghasilan.nama_lengkap_anak}
                      onChange={handlePenghasilanChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={formPenghasilan.nik_anak}
                      onChange={handlePenghasilanChange}
                      className={inputClass}
                      required
                    />
                  ...
                  <div>
                    <label className={labelClass}>
                      Tempat, tanggal lahir anak (Jika ada)
                    </label>
                    <input
                      name="tempat_tanggal_lahir_anak"
                      placeholder="Contoh: Jakarta, 15 Agustus 2000"
                      value={formPenghasilan.tempat_tanggal_lahir_anak}
                      onChange={handlePenghasilanChange}
                      className={inputClass}
                    />
                  </div>
                  <div>
                    <label className={labelClass}>
                      Jenis kelamin anak (Jika ada)
                    </label>
                    <input
                      name="jenis_kelamin_anak"
                      placeholder="Laki-laki / Perempuan"
                      value={formPenghasilan.jenis_kelamin_anak}
                      onChange={handlePenghasilanChange}
                      className={inputClass}
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      value={formPenghasilan.agama_anak}
                      onChange={handlePenghasilanChange}
                      className={inputClass}
                    />
                  </div>
                  <div>
                    <label className={labelClass}>
                      Pekerjaan anak (Jika ada)
                    </label>
                    <input
                      name="pekerjaan_anak"
                      placeholder="Masukkan pekerjaan anak"
                      value={formPenghasilan.pekerjaan_anak}
                      onChange={handlePenghasilanChange}
                      className={inputClass}
                    />
                  </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 gap-4">
                  <div>
                    ...
                    <textarea
                      name="keperluan"
                      placeholder="Masukkan keperluan surat penghasilan"
                      value={formPenghasilan.keperluan}
                      onChange={handlePenghasilanChange}
                      className={inputClass + " min-h-[80px]"}
                      required
                    />
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        value={formPenghasilan.penghasilan_per_bulan}
                        onChange={handlePenghasilanChange}
                        className={inputClass}
                        required
                      />
                    ...
                    <div>
                      <label className={labelClass}>
                        Jurusan/Prodi (Jika ada)
                      </label>
                      <input
                        name="jurusan_prodi"
                        placeholder="Masukkan jurusan/program studi"
                        value={formPenghasilan.jurusan_prodi}
                        onChange={handlePenghasilanChange}
                        className={inputClass}
                      />
                    </div>
