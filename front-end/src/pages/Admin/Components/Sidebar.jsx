      ...
      icon: (
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v12a2 2 0 01-2 2zM16 8V4M12 8V4M8 8V4"
          />
        </svg>
      ),
    },
        ...
        <div className="p-6 border-b border-white/10">
          <div className="flex items-center gap-3">
            <img
              src={
                admin?.foto
                  ? `https://desasidodadiasri.my.id/api/admin/${admin.foto}`
                  : "https://ui-avatars.com[https://desasidodadiasri.my.id/api](https://desasidodadiasri.my.id/api)?name=Admin&background=ffffff33&color=fff"
              }
              alt="Admin"
