...
const Artikel = () => {
  ...
  const openEdit = (a) => {
    ...
    setImg(null);
    setPreview(
      a.img ? `https://desasidodadiasri.my.id/api/artikel/${a.img}` : null,
    );
    setShow(true);
  };
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black text-gray-800 uppercase tracking-tighter">
            Media & <span className="text-[#2F4156]">Artikel</span>
          </h1>
          <p className="text-xs text-gray-500 font-medium">
            Kelola publikasi dan informasi Desa Sidodadi Asri
          </p>
        </div>
        ...
        <div className="flex gap-2">
          ...
          <button
            onClick={openAdd}
            className="shrink-0 text-white text-xs font-black uppercase tracking-widest px-6 py-3 rounded-xl hover:shadow-lg transition-all active:scale-95"
                ...
                {filteredData.map((a, i) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className="w-16 h-16 rounded-2xl overflow-hidden shadow-md border-2 border-white group-hover:scale-105 transition-transform">
                        <img
                          src={
                            a.img
                              ? `https://desasidodadiasri.my.id/api/artikel/${a.img}`
                    ...
                    <td className="px-6 py-4 space-y-1">
                      <h4 className="font-black text-gray-800 text-sm leading-tight line-clamp-1">
                        {a.judul_artikel}
                      </h4>
                      <p className="text-[11px] text-gray-400 leading-relaxed line-clamp-2 italic font-serif">
                        {(a.deskripsi || "").slice(0, 100)}...
                      </p>
                    </td>
                    <td className="px-6 py-4 text-center">
                      <div className="inline-flex flex-col bg-gray-100 px-3 py-1.5 rounded-xl">
                        ...
                        <span className="text-[9px] font-bold text-gray-400 uppercase tracking-widest">
                          {new Date(a.tgl_post).toLocaleTimeString("id-ID", {
                            hour: "2-digit",
                            minute: "2-digit",
                          })}{" "}
                          WIB
          ...
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[100] p-4">
            ...
            >
              ...
              <div className="space-y-4">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full border-2 border-gray-100 rounded-2xl px-4 py-3 text-sm font-bold focus:border-[#2F4156] outline-none transition-all"
                    required
                  />
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    ...
                    className="w-full border-2 border-gray-100 rounded-2xl px-4 py-3 text-sm h-48 resize-none font-medium focus:border-[#2F4156] outline-none transition-all leading-relaxed"
                    required
                  />
                </div>
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  type="submit"
                  className="flex-[2] text-white py-4 rounded-2xl text-xs font-black uppercase tracking-[0.3em] hover:shadow-xl active:scale-95 transition-all"
                  style={{ backgroundColor: Warna.primary }}
                >
