...
**Website Resmi Desa Sidodadi Asri** adalah platform digital terpadu yang dirancang untuk modernisasi tata kelola pemerintahan desa dan peningkatan kualitas pelayanan publik. Platform ini mengintegrasikan layanan administrasi persuratan, transparansi informasi desa, profil SOTK, serta publikasi berita/kegiatan masyarakat secara _real-time_.

---

## ✨ Fitur-Fitur Utama

- **🏠 Beranda Interaktif:** Pengenalan desa, pengumuman penting berbasis _marquee banner_, dan akses cepat ke layanan publik.
...
- **📞 Pusat Kontak & Aspirasi:** Informasi jam operasional, peta lokasi kantor desa, serta integrasi _one-click_ ke WhatsApp Resmi Pemdes.
...
│   ├── routes/                # Endpoint API ([https://desasidodadiasri.my.id/api](https://desasidodadiasri.my.id/api)artikel, dll)
...
_Server Backend akan berjalan secara default pada:_ `http://127.0.0.1:8000`
...
_Server Frontend akan berjalan secara default pada:_ `http://localhost:5173`
